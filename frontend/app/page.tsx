...
// Fase 0: esta página existe só para provar que o frontend alcança o backend e que o backend
// alcança Postgres e Redis. A tela de análise entra na Fase 1.
...
function CartaoServico({ nome, saude }: { nome: string; saude: SaudeServico }) {
  ...
  // Acessibilidade de verdade (contraste AA, ícone, fonte grande) é entrega da Fase 1.
  return (
